<div class="row content">
    <div class="row">
       ...
       <?php
       $sqldata = "SELECT DISTINCT data_criacao FROM vendas WHERE situacao='pendente' and cliente_id='". $_GET['cliente'] ."'";
...
<tr class="alert-info">
                    ...
                    <tbody>
                    <?php
                     $sql1 = "SELECT *FROM vendas WHERE situacao='pendente' and cliente_id='". $_GET['cliente'] ."'";
                                $result1 = mysqli_query($con, $sql1);
                                while ($rowp1 = mysqli_fetch_array($result1)) {
                                  $idp = $rowp1['id_orcamento'];
                                    ?>
                                    <tr>
                              ...
                              <?php  
                                ...
                                ?>
                                 ...
                                 <tr>
                                 <?php 
                                       $sql3 = "SELECT SUM(total),SUM(desconto),SUM(quant) FROM vendas WHERE cliente_id='". $_GET['cliente'] ."' AND situacao='pendente'";
       ...
       <tr>
        ...
        <div class="text-right">
          <a href="?page=vendas" class="btn btn-info">Voltar </a>
          <a href="data/salvar_em_quitados.php?id=<?php echo $idp; ?>&preco=<?php echo number_format($preco,2,'.','.'); ?>&tipo=<?php echo $_GET['tipo']; ?>" class="btn btn-success">Concluir venda</a>
