<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    ...
    ?>
        <center>
            ...
            <a href="../admin.php?page=add_pedras" class="btn btn-danger">Voltar a lista de pedras</a>

        </center>
    <?php
    } else {
        $check = "SELECT * FROM pedras WHERE ID='$id'"; 
    ...
    ?>
        <center>
            ...
            <a href="../admin.php?page=add_pedras" class="btn btn-success">Voltar a lista de pedras</a>
    ...
    <?php
            ...
            ?>
<center>
            <h2>Essa pedra não existe, tente novamente.</h2>
            <a href="../admin.php?page=add_pedras" class="btn btn-danger">Voltar a lista de pedras</a>
